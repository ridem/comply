...
var pandocArgs = []string{"-f", "markdown+smart+raw_tex+raw_attribute+backtick_code_blocks", "--filter", "./customfilter.py", "--toc", "-N", "--fail-if-warnings", "--resource-path", ".:static", "--template", "templates/default.latex", "-o"}
